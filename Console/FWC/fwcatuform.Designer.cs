...
namespace PowerSDR
{
    ...
    public partial class FWCATUForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.chkUseTUN, resources.GetString("chkUseTUN.ToolTip"));
            // 
            // btnTuneFull
            // 
            ...
            this.toolTip1.SetToolTip(this.btnTuneFull, "Semi-Automatic Mode only.\r\nPerform Full Tune.\r\nIgnores any previous saved memory " +
        "based tunes on the current frequency.");
            ...
            this.toolTip1.SetToolTip(this.btnTuneMemory, "Semi-Automatic mode only.\r\nPerforms a Memory based Tune.\r\nUses previously saved t" +
        "une settings if found for the current frequency. \r\nIf a previous setting is not " +
        "found, a \"Full Tune\" is performed.");
            ...
            this.toolTip1.SetToolTip(this.radModeAuto, "Activates the ATU requiring just RF to automatically begin a tuning sequence. \r\nT" +
        "his works for all transmission modes.  \r\nNote: Not all Tuners will respond to th" +
        "is command");
