//=================================================================
// SDRSerialPortIV.cs CXAuto ke9ns
//=================================================================
...
namespace PowerSDR
{
    public class SDRSerialPort7
    {
        ...
        public static event SerialRXEventHandler serial_rx_event7; // ke9ns add for CXAuto port
        ...
        public SDRSerialPort7(int portidx)
        {
            ...
            commPort.DataReceived += new SerialDataReceivedEventHandler(this.SerialReceivedData7);
            ...
            commPort.DataBits = 8;
            commPort.BaudRate = 9600;  // .181 was 9600 but 4800 works direct with hygain ant rotor and ddutil
        ...
        public uint put1(string s) // get ant pos from CXauto
        {
        ...
        // ke9ns add
        void SerialReceivedData7(object source, SerialDataReceivedEventArgs e)
        {
            serial_rx_event7(this, new SerialRXEvent(commPort.ReadExisting()));
