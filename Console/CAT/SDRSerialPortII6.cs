//=================================================================
// SDRSerialPort.cs ke9ns clone for port 6
...
namespace PowerSDR
{
    ...
    {
        public static event SerialRXEventHandler serial_rx_event6;
        ...
        public SDRSerialPort6(int portidx)
        {
            ...
            commPort.DataReceived += new SerialDataReceivedEventHandler(this.SerialReceivedData6);
        ...
        void SerialReceivedData6(object source, SerialDataReceivedEventArgs e)
        {
            serial_rx_event6(this, new SerialRXEvent(commPort.ReadExisting()));
