//=================================================================
// SDRSerialPort.cs ke9ns clone for port 5
...
namespace PowerSDR
{
    ...
    {
        public static event SerialRXEventHandler serial_rx_event5;
        ...
        public SDRSerialPort5(int portidx)
        {
            ...
            commPort.DataReceived += new SerialDataReceivedEventHandler(this.SerialReceivedData5);
        ...
        void SerialReceivedData5(object source, SerialDataReceivedEventArgs e)
        {
            serial_rx_event5(this, new SerialRXEvent(commPort.ReadExisting()));
