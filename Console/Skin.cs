...
namespace PowerSDR
{
    ...
    public class Skin
    {
        ...
        public static bool Restore(string name, string p, Form f)
        {
            ...
            f.Name = f.Name.Replace("ptbVACRX2Gain", "ptbVACRXGain"); // ke9ns .315
            f.Name = f.Name.Replace("ptbVACTX2Gain", "ptbVACTXGain"); // ke9ns .315
        ...
        private static void SetupButtonImages(Button ctrl)
        {
            ...
            s = s.Replace("ptbVACRX2Gain", "ptbVACRXGain"); // ke9ns .315
            s = s.Replace("ptbVACTX2Gain", "ptbVACTXGain"); // ke9ns .315
        ...
        public static void SetBackgroundImage(Control c)
        {
            ...
            c.Name = c.Name.Replace("ptbVACRX2Gain", "ptbVACRXGain"); // ke9ns .315
            c.Name = c.Name.Replace("ptbVACTX2Gain", "ptbVACTXGain"); // ke9ns .315
